package com.a404.duckonback.domain.room.repository;

import com.a404.duckonback.domain.room.entity.Room;
import com.a404.duckonback.domain.room.dto.RoomSummaryDTO;
...
//    @Query("""
//            SELECT new com.a404.duckonback.domain.room.dto.RoomSummaryDTO(
